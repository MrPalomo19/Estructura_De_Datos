...
public class Tools {
	 ...
	 // Menu Botones Opciones de Busquedas
	    public static String BotonesBusquedas(String menu) {
		   try {
		   String opcion[]= {"GENERAR ORDENADO","BUSQUEDAS ORDENADAS","GENERAR ALEATORIO","BUSQUEDAS DESORDENADAS","IMPRIMIR","VACIAR","SALIR"};
		   int n;
		   n = JOptionPane.showOptionDialog(null,"SELECCIONA DANDO CLICK","M E N U", JOptionPane.NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, opcion, opcion[0]);
		   return (opcion[n]);
		   } catch (Exception e) {
	 ...
	 // Menu delizable Busquedas Desordenadas   
	    public static String BusqDes() {
	    	try {
	 		   String opcion[]= {"SECUENCIAL","KNUTH MORRIS PRATT"};
	 		   int n;
	 		   n = JOptionPane.showOptionDialog(null,"OPCIONES DE BUSQUEDAS DESORDENADAS","M E N U", JOptionPane.NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, opcion, opcion[0]);
	 		   return (opcion[n]);
	 		   } catch (Exception e) {
	 			   System.exit(0);
	 		   } return null;
	 ...
	 // Menu delizable Busquedas Ordenadas   
	    public static String BusqOrd() {
	    	try {
	 		   String opcion[]= {"BINARIA","INTERPOLACION","EXPONENCIAL","FIBONACCI","SALTAR BUSQUEDA"};
	 		   int n;
	 		   n = JOptionPane.showOptionDialog(null,"OPCIONES DE BUSQUEDAS ORDENADAS","M E N U", JOptionPane.NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, opcion, opcion[0]);
	 		   return (opcion[n]);
	 		   } catch (Exception e) {
	 			   System.exit(0);
	 		   } return null;
