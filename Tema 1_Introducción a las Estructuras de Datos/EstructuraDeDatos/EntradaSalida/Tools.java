...
public class Tools {
	...
	public static  byte leerByte(String msje) {
	   ...
	   public static String menuDesord(String menu) {
		   String opcion[]= {"Agregar Datos","Imprimir","Buscar","Eliminar","Modificar","Salir"};
		   int n;
		   n = JOptionPane.showOptionDialog(null,"SELECCIONA DANDO CLICK","M E N U", JOptionPane.NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, opcion, opcion[0]);
		   return (opcion[n]);
	   }
	   
	   public static String menuOrd(String menu) {
		   String opcion[]= {"Agregar Datos","Imprimir","Buscar","Eliminar","Modificar","Salir"};
		   int n;
		   n = JOptionPane.showOptionDialog(null,"SELECCIONA DANDO CLICK","M E N U", JOptionPane.NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, opcion, opcion[0]);
		   return (opcion[n]);
	   ...
	   public static String menuExam(String menu) {
		   String opcion[]= {"Agregar Datos","Imprimir","Eliminar","Salir"};
		   int n;
		   n = JOptionPane.showOptionDialog(null,"SELECCIONA DANDO CLICK","M E N U", JOptionPane.NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, opcion, opcion[0]);
		   return (opcion[n]);
	   }
